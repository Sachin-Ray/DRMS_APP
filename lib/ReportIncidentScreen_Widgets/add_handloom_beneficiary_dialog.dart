...
class _AddHandloomBeneficiaryDialogState
  ...
  Future<void> _uploadEnclosures() async {
    ...
    if (success) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("✅ Handloom Beneficiary + Enclosures Uploaded"),
                        ...
                        child: Column(
                          children: [
                            ...
                            AccordionSection(
                              ...
                              children: [
                                HandloomAssistanceWidget(model: assistance)
                              ],
                            ),
                            AccordionSection(
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed:
                        isSubmitting ? null : _submitHandloomBeneficiary,
                    child: isSubmitting
                        ? const CircularProgressIndicator(color: Colors.white)
                        : const Text("Save Handloom Beneficiary"),
                  ),
                ),
              ),
            ],
